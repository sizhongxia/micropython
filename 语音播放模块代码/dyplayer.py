...
class DYPlayer():
    ...
    """
    def __init__(self):
        # self._uart = UART(0, baudrate=9600, tx=1, rx=3)
        self._uart = UART(2, baudrate=9600, tx=17, rx=16)
    ...
    def add_volume(self):
        """音量+"""
        cmd_buff = bytearray([0xaa, 0x14, 0x00, 0xbe])
        print(cmd_buff)
        self._uart.write(cmd_buff)
